...
void init_ipad_air_2_10_1_1_14b100() {
    printf("setting offsets for iPad Air 2 10.1.1\n");
  ...
  if (strstr(u.machine, "iPad4,4")) {
    ...
    if (strstr(u.machine, "iPad5,3")) {
        ...
        if (strstr(u.version, "root:xnu-3789.22.3~1/RELEASE_ARM64_T7001")){
            printf("this is a known kernel build for iPad Air 2 - offsets should be okay\n");
        } else {
            unknown_build();
        }
        init_ipad_air_2_10_1_1_14b100();
        return;
    }
